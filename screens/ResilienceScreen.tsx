    ...
    <div className="max-w-5xl mx-auto px-6 py-12 flex flex-col gap-10">
           ...
           <div className="bg-white p-10 rounded-[3rem] border border-gray-100 shadow-sm space-y-8 flex-1">
              <div className="flex items-center gap-4">
                 ...
                 <div>
                    ...
                    <p className="text-xs text-gray-400 font-bold uppercase tracking-widest">Legal & Regulatory Model</p>
                 </div>
              </div>
                 ...
                 {landTypes.map(type => (
                   <button
                     ...
                     className={`flex items-center justify-between p-5 rounded-2xl border-2 transition-all ${
                       data.landType === type ? 'border-[#13a4ec] bg-[#13a4ec]/5 text-[#13a4ec]' : 'border-gray-50 bg-gray-50 text-gray-500 hover:border-gray-200'
                     }`}
                   >
                     <span className="font-black text-sm">{type}</span>
                     <span className="material-symbols-outlined text-xl">{data.landType === type ? 'radio_button_checked' : 'radio_button_unchecked'}</span>
                   </button>
                 ))}
              </div>
                ...
                {[
                  ...
                  <button
                    ...
                    className={`flex items-center gap-5 p-6 rounded-[2rem] border-2 transition-all group ${
                      data.infrastructure[item.key as keyof typeof data.infrastructure] ? 'border-[#13a4ec] bg-[#13a4ec]/5 text-[#13a4ec]' : 'border-gray-50 bg-gray-50 text-gray-500 hover:border-gray-100 opacity-70'
                    }`}
                  >
      ...
      <div className="bg-[#111618] rounded-[3rem] p-12 text-white flex flex-col md:flex-row items-center gap-10 shadow-[0_25px_60px_-15px_rgba(0,0,0,0.3)] relative overflow-hidden group">
         ...
         <button 
           ...
           className={`min-w-[200px] h-16 px-12 rounded-2xl font-black transition-all border-2 text-sm uppercase tracking-widest ${
             data.enhancedResilience 
