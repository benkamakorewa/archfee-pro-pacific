      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
        ...
        <div className="lg:col-span-4 flex flex-col gap-6">
           <div className="bg-[#111618] rounded-[3.5rem] p-12 text-white shadow-2xl relative overflow-hidden group">
              ...
              <h2 className="text-6xl font-black text-[#13a4ec] tracking-tighter mb-12">{formatCurrency(results.constructionCost)}</h2>
           ...
           <div className="bg-white p-10 rounded-[3rem] border border-gray-100 shadow-sm space-y-8">
              <div className="flex items-center gap-3">
                 ...
                 <h4 className="font-black text-sm uppercase tracking-widest">Bank Repayment Est.</h4>
              </div>
        ...
        <div className="lg:col-span-8 flex flex-col gap-8">
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <button 
                ...
                className={`p-10 rounded-[3rem] border-2 text-left transition-all flex flex-col gap-8 relative overflow-hidden group ${
                  projectData.selectedFeeOption === FeeOption.PERCENTAGE ? 'border-[#13a4ec] bg-white shadow-2xl' : 'border-white bg-white hover:border-gray-50'
                }`}
              >
              ...
              <button 
                ...
                className={`p-10 rounded-[3rem] border-2 text-left transition-all flex flex-col gap-8 relative overflow-hidden group ${
                  projectData.selectedFeeOption === FeeOption.FIXED ? 'border-[#13a4ec] bg-white shadow-2xl' : 'border-white bg-white hover:border-gray-50'
                }`}
              >
